...
const PORT = 3000;
const AI_SERVER_PORT = 3001; // Port where OLD-server.js will run
const NGROK_CONFERENCE_URL = 'ff3c1c367f6a.ngrok-free.app'; // Port 3000
...
const conferenceState = {
    isActive: false,
    aiCallSid: null,
    conferenceName: 'Zeus_Conference'
};
...
// Conference status callback - handles conference events
...
// TwiML for AI bot to join conference
...
// Status callback for AI bot call
...
// Alternative approach: Bridge AI bot through a separate call
